...
# python3 lora_cfimdb_only.py --lr 1e-5 --use_gpu --lora_r 1 --fine-tune-mode full-model
# python3 lora_cfimdb_only.py --lr 1e-5 --use_gpu --lora_r 5 --fine-tune-mode full-model
# python3 lora_cfimdb_only.py --lr 1e-5 --use_gpu --lora_r 10 --fine-tune-mode full-model
# python3 lora_cfimdb_only.py --lr 1e-5 --use_gpu --lora_r 25 --fine-tune-mode full-model
# python3 lora_cfimdb_only.py --lr 1e-5 --use_gpu --lora_r 50 --fine-tune-mode full-model
# python3 lora_cfimdb_only.py --lr 1e-5 --use_gpu --lora_r 100 --fine-tune-mode full-model

# python3 classifier.py --lr 1e-5 --use_gpu --fine-tune-mode full-model

python3 lora_sst_only.py --lr 1e-5 --use_gpu --lora_r 1 --fine-tune-mode full-model
python3 lora_sst_only.py --lr 1e-5 --use_gpu --lora_r 5 --fine-tune-mode full-model
python3 lora_sst_only.py --lr 1e-5 --use_gpu --lora_r 10 --fine-tune-mode full-model
python3 lora_sst_only.py --lr 1e-5 --use_gpu --lora_r 25 --fine-tune-mode full-model
python3 lora_sst_only.py --lr 1e-5 --use_gpu --lora_r 50 --fine-tune-mode full-model
python3 lora_sst_only.py --lr 1e-5 --use_gpu --lora_r 100 --fine-tune-mode full-model