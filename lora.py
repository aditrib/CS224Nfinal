...
# Adapt BertSentimentClassifier to use LoRA-Config
class BertSentimentClassifier(torch.nn.Module):
    def __init__(self, config):
        ...
        # Load BERT configuration and set use_return_dict explicitly, otherwise bug
        # only necessary with default model
        # bert_config = BertModel.from_pretrained('bert-base-uncased').config
        # bert_config.use_return_dict = True
    ...
    def forward(self, input_ids, attention_mask):
        ...
        pooler_out = bert_out['pooler_output']  # (N, D) (the embeddings of the [CLS] token, 'embeds[:, 0, :]')
